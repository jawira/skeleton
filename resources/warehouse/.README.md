...
<dt>
    ...
    <img alt="GitHub stars" src="https://img.shields.io/github/stars/jawira/case-converter?style=social"/></a>
</dt>
...
<dt>
    ...
    <img alt="GitHub stars" src="https://img.shields.io/github/stars/jawira/emoji-catalog?style=social"/></a>
</dt>
<dd>Get access to +3000 emojis as class constants.</dd>

<dt>
    <a href="https://packagist.org/packages/jawira/phing-open-task">jawira/phing-open-task
    <img alt="GitLab stars" src="https://badgen.net/gitlab/stars/jawira/phing-open-task?color=orange&icon=gitlab"/></a> 
</dt>
...
<dt><a href="https://packagist.org/packages/jawira/plantuml-encoding">jawira/plantuml-encoding
<img alt="GitHub stars" src="https://img.shields.io/github/stars/jawira/plantuml-encoding?style=social"></a></dt>
